jQuery(document).ready(function($) {
	...
	// var tabOpen = urlParams.get('tab');
	// 	document.getElementById(tabOpen).style.display = "block";

	// 	$('.ui-tabs-panel').not(tabOpen).each(function() {
	...
	$('input[type="submit"]').on('click', function(e) {
        ...
        window.location.href = window.location.href+"&"+$.param({'tab': tab});
    });



	$('#single_entry').on('change', function(){
		$('#single_entry_table').toggle();
	});
	...
	$('#table_select').change(function() {  // Get column count and load table
		...
		$('#remove_autoinc_column').prop('checked', true);
